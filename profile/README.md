# EMPIRIC  
Welcome to the EMPIRIC GitHub Organization. EMPIRIC develops tools to improve climate model data accessibility and extreme‑event analysis for small island and coastal states—with a focus on Pacific Island Countries and Territories (PICTs).
